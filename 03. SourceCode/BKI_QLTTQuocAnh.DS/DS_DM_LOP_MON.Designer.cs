...
namespace BKI_QLTTQuocAnh.DS {
    ...
    public partial class DS_DM_LOP_MON : global::System.Data.DataSet {
        ...
        public partial class DM_LOP_MONDataTable : global::System.Data.TypedTableBase<DM_LOP_MONRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DM_LOP_MONRow AddDM_LOP_MONRow(string MA_LOP_MON, string MO_TA, decimal DON_GIA_BUOI_HOC) {
...
namespace BKI_QLTTQuocAnh.DS.DS_DM_LOP_MONTableAdapters {
    ...
    public partial class DM_LOP_MONTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[DM_LOP_MON] WHERE (([ID] = @Original_ID) AND ([MA_LOP_MON] = @Original_MA_LOP_MON) AND ((@IsNull_MO_TA = 1 AND [MO_TA] IS NULL) OR ([MO_TA] = @Original_MO_TA)) AND ((@IsNull_DON_GIA_BUOI_HOC = 1 AND [DON_GIA_BUOI_HOC] IS NULL) OR ([DON_GIA_BUOI_HOC] = @Original_DON_GIA_BUOI_HOC)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[DM_LOP_MON] ([MA_LOP_MON], [MO_TA], [DON_GIA_BUOI_HOC]) VALUES" +
                " (@MA_LOP_MON, @MO_TA, @DON_GIA_BUOI_HOC);\r\nSELECT ID, MA_LOP_MON, MO_TA, DON_GI" +
                "A_BUOI_HOC FROM DM_LOP_MON WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[DM_LOP_MON] SET [MA_LOP_MON] = @MA_LOP_MON, [MO_TA] = @MO_TA, [DON_GIA_BUOI_HOC] = @DON_GIA_BUOI_HOC WHERE (([ID] = @Original_ID) AND ([MA_LOP_MON] = @Original_MA_LOP_MON) AND ((@IsNull_MO_TA = 1 AND [MO_TA] IS NULL) OR ([MO_TA] = @Original_MO_TA)) AND ((@IsNull_DON_GIA_BUOI_HOC = 1 AND [DON_GIA_BUOI_HOC] IS NULL) OR ([DON_GIA_BUOI_HOC] = @Original_DON_GIA_BUOI_HOC)));
SELECT ID, MA_LOP_MON, MO_TA, DON_GIA_BUOI_HOC FROM DM_LOP_MON WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, MA_LOP_MON, MO_TA, DON_GIA_BUOI_HOC FROM dbo.DM_LOP_MON";
        ...
        public virtual int Delete(decimal Original_ID, string Original_MA_LOP_MON, string Original_MO_TA, global::System.Nullable<decimal> Original_DON_GIA_BUOI_HOC) {
        ...
        public virtual int Insert(string MA_LOP_MON, string MO_TA, global::System.Nullable<decimal> DON_GIA_BUOI_HOC) {
            if ((MA_LOP_MON == null)) {
        ...
        public virtual int Update(string MA_LOP_MON, string MO_TA, global::System.Nullable<decimal> DON_GIA_BUOI_HOC, decimal Original_ID, string Original_MA_LOP_MON, string Original_MO_TA, global::System.Nullable<decimal> Original_DON_GIA_BUOI_HOC, decimal ID) {
            if ((MA_LOP_MON == null)) {
                throw new global::System.ArgumentNullException("MA_LOP_MON");
            }
            else {
            ...
            if ((Original_MA_LOP_MON == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Original_MA_LOP_MON));
            }
            if ((Original_MO_TA == null)) {
            ...
            if ((Original_DON_GIA_BUOI_HOC.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[8].Value = ((decimal)(Original_DON_GIA_BUOI_HOC.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MA_LOP_MON, string MO_TA, global::System.Nullable<decimal> DON_GIA_BUOI_HOC, decimal Original_ID, string Original_MA_LOP_MON, string Original_MO_TA, global::System.Nullable<decimal> Original_DON_GIA_BUOI_HOC) {
            return this.Update(MA_LOP_MON, MO_TA, DON_GIA_BUOI_HOC, Original_ID, Original_MA_LOP_MON, Original_MO_TA, Original_DON_GIA_BUOI_HOC, Original_ID);
        }
    }
