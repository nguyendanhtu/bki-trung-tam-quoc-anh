///************************************************
/// Generated by: haihd
/// Date: 29/01/2015 03:41:51
/// Goal: Create User Service Class for V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON
///************************************************
/// <summary>
/// Create User Service Class for V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON
/// </summary>
...
namespace BKI_QLTTQuocAnh.US
{
    ...
    public class US_V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON : US_Object
    {
        private const string c_TableName = "V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON";
        ...
        public US_V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON()
        {
            pm_objDS = new DS_V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON();
            pm_strTableName = c_TableName;
            pm_objDR = pm_objDS.Tables[pm_strTableName].NewRow();
        }

        public US_V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON(DataRow i_objDR)
            : this()
        {
            this.DataRow2Me(i_objDR);
        }

        public US_V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON(decimal i_dbID)
        {
            pm_objDS = new DS_V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON();
            pm_strTableName = c_TableName;
        ...
        #region additional
        public void FillDatasetSearch(DS_V_RPT_415_BC_HS_CHUA_NOP_TIEN_THEO_LOP_MON iop_ds
        ...
        {
            CStoredProc v_obj = new CStoredProc("f415_bc_hs_chua_nop_tien_theo_lop_mon");
