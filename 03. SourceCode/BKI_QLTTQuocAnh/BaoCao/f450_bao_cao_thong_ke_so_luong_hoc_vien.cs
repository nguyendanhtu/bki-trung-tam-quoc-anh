...
{
    public partial class f450_bao_cao_thong_ke_so_luong_hoc_vien : Form
    {
        public f450_bao_cao_thong_ke_so_luong_hoc_vien()
        {
            InitializeComponent();
            format_controls();
        }
...
, TONG_SO_HS = 2
        ...
        {
            //	V_RPT_450_BAO_CAO_SO_LUONG_LUONG_HOC_VIEN_HIEN_NAY_DE v_fDE = new  V_RPT_450_BAO_CAO_SO_LUONG_LUONG_HOC_VIEN_HIEN_NAY_DE();								
            //	v_fDE.display();
            load_data_2_grid();
        }
